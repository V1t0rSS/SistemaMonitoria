...
<body class="bg-light">
    ...
    <div id="main-container" class="bg-body">
        <div class="d-flex justify-content-between">
            ...
            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#usuarioModal">Adicionar Administrador <i class='bx bx-plus'></i></button>
        </div>
        <div class="container mt-4 px-0">
            <table id="lista_de_administradores" class="table table-striped" style="width:100%">
                <thead>
                    <tr>
                        <th>Nome</th>
                        <th>Matrícula</th>
    ...
    <div class="modal fade" id="usuarioModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form id="adicionaradministrador" action="#" method="POST">
...
<script>
    $(document).ready(function() {
        $('#example').DataTable();
        $('#usuarioModal').modal();
        $("#adicionaradministrador").on('submit', controleAdministrador.post);
